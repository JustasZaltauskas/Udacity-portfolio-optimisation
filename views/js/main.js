...
>>>>>>> 15e11b821c06369c52caa72926987ca55cb8a8c5
...
<<<<<<< HEAD
  ...
  pizzaImage.src = "images/pizza-optimised.png";
=======
  pizzaContainer = document.createElement("div");
  pizzaImageContainer = document.createElement("div");
  pizzaImage = document.createElement("img");
...
<<<<<<< HEAD
  var scrolledFromTheTop = document.body.scrollTop / 1250;
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin(scrolledFromTheTop + (i % 5));
=======
  for (var i = 0; i < items.length; i++) {
...
<<<<<<< HEAD
    elem.src = "images/pizza-optimised.png";
=======
